...
SG_Componentes.Controller = P_of_U_Control.empty(0,numel(el_ids));
% Spannungsregler an Lastanschlüsse "anschließen":
for i=1:numel(el_ids)
	SG_Componentes.Controller(i) = P_of_U_Control(...
