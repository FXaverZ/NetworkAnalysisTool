function [handles, infostr] = update_NVIEW_control_panel_simulation_options(handles)
...
if isfield(handles.NVIEW_Control,'Simulation_Options')
    ...
    set(handles.static_text_result_details, 'String',infostr,'FontName','MS Sans Serif');
end
