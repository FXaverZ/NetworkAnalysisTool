function histogram_violated_branch_numbers_overall(handles,d)
...
for i = 1 : numel(cg)
    Table.Values(:,i) = d.(cg{i}).branch_violated_at_datasets(:);
end, clear i
Table.Description = 'Branches affected by overcurrents histogram';
% Create histogram
...
HistXLabel = 'Percentage of branches where overcurrents occured';
