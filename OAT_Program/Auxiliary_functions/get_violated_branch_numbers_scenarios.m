function Table = get_violated_branch_numbers_scenarios(d)
...
Table.Name = 'Percentage of branches where overcurrents occured';
...
Table.Description = 'Number of branches affected by overcurrents seperated by scenarios';
