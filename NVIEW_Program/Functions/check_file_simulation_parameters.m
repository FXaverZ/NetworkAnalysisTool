...
for i = 1 : numel(SelectedFiles)
    ...
    csfc.Input_values_used(i,1) = ...
        find([Current_Settings.Data_Extract.get_Sample_Value,Current_Settings.Data_Extract.get_Mean_Value,...
        Current_Settings.Data_Extract.get_Min_Value, Current_Settings.Data_Extract.get_Max_Value,...
        Current_Settings.Data_Extract.get_95_Quantile_Value,Current_Settings.Data_Extract.get_05_Quantile_Value,...
        Current_Settings.Data_Extract.get_Time_Series]);
