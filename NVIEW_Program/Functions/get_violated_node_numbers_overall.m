function Table = get_violated_node_numbers_overall(handles,d,s)
...
Table.Name = '% of nodes with voltage violations';
...
Table.RowName = '';
Table.Description = 'Overall number of grid nodes affected by voltage violations';
