function histogram_violated_node_numbers_overall(handles,d,s)
...
for i = 1 : numel(cg)    
    Table.Values(:,i) = d.(cg{i}).bus_violated_at_datasets(:);
end, clear i   
Table.Description = 'Nodes affected by voltage violation histogram';
% Create histogram
...
HistXLabel = 'Percentage of nodes where voltage violations occured';
