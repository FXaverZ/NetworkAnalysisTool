function Table = create_current_violation_sum_time_table_per_grid(d,Data_List)
...
for i = 1 : numel(Data_List)
    ...
    Table.(Data_List{i}).Description =  ['Total number of current violations at ',(Data_List{i}), ' timeline'];
    Table.(Data_List{i}).RowName =  'Total number of overcurrent violations at grid (%)';
