...
% ID ,  Sub-Structure Name                              , Color           , LineStyle, String for legend 
    ...
    3, 'g03_Add_Cable_to_First_OH_Line'                 ,[256,256,256]/256, ':'      , 'Verst�rkung Oberleitung';...
    4, 'g04_Add_Cable_to_Weak_Cables'                   ,[256,256,256]/256, '-'      , 'Verst�rkung Kabel';...
	}; 
...
Labels_Title_one_Scenario    = ['Mittlerer Verlauf Spannung f�r Szenario "',Settings_Scenarios{Option_Active_Scenarios,2},'"'];
...
Labels_Title_one_Scenario    = ['Histogramm f�r Szenario "',Settings_Scenarios{Option_Active_Scenarios,5},'"'];
