...
% ID  ,  Data Set ID  ,  Legendstr.        Exceldatei
	 1, 'Households'  , 'Haushaltslast'   ,'MS_Auswertungsexcel_Szenarien_Load.xlsm';...
	 2, 'Solar'       , 'PV Einspeisung'  ,'MS_Auswertungsexcel_Szenarien_PV.xlsm';...
	 3, 'El_Mobility' , 'Elektromobilit�t','MS_Auswertungsexcel_Szenarien_E-Mob.xlsm';...
	 4, 'LV_Griddata' , 'NS-Netzdaten'    ,'MS_Auswertungsexcel_Szenarien_Balance.xlsm';...
	};
% = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
%% Laden der Daten
