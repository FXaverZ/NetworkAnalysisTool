...
if nargin >= 1 % User gives size wishes
	if strcmpi(varargin{1},'compact')
		pos = [0,89,426,300];     % B: 33% von 'large', H:  8.00 cm -->  4.0cm in Word
	elseif strcmpi(varargin{1},'medium')
		pos = [0,89,640,527];     % B: 50% von 'large', H: 14.00 cm -->  7.0cm in Word
	elseif strcmpi(varargin{1},'large')
		pos = [0,89,1280,602];    % B:100% von 'large', H: 16.00 cm -->  8.0cm in Word
	else
