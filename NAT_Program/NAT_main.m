...
function edit_pqnode_pv_installed_power_Callback(hObject, ~, handles) %#ok<DEFNU>
...
settin.Plants.(name).Power_Installed = str2double(get(hObject,'String'));
% Umrechnen von kWp auf Oberfläche auf Wp:
settin.Plants.(name).Power_Installed = settin.Plants.(name).Power_Installed * 1000;
