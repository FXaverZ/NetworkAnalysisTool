function [handles, error] = load_input_last_settings(handles)
...
% try to load one set of the loaddata according to the current settings:
try
	...
	settin.Simulation.Number_Runs = settin.Data_Extract.Number_Data_Sets;
