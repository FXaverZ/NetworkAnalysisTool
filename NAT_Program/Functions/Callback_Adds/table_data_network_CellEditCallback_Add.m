...
if col == idx_pv
	...
	sel = find(strcmp(handles.Current_Settings.Table_Network.Data{row_act,idx_pv}, ...
		settin.Selectable(:,1)));
...
idx_hh_num = find(strcmp(handles.Current_Settings.Table_Network.ColumnName,'Hh. Number'));
if col == idx_hh_num
	handles = edit_pqnode_hh_number(handles,row_act,eventdata.EditData);
end
