classdef Voltage_Post_Processing1
...
% Letzte Änderung durch:   Matej Rejc - 14.05.2013
    ...
    methods
        function obj = Voltage_Post_Processing1(information_file)
        ...
        function histogram_comparisons_grids_at_scenario(obj,varargin)
            ...
            % Check input varargin
            S = input_check(1,1,varargin); % Scenario, grid, excel_output
        ...
        function histogram_comparisons_scenarios_at_grid(obj,varargin)
            G = input_check(1,1,varargin); % Scenario, grid, excel_output
