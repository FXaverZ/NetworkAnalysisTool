function varargout = input_check_hist(cond1, cond2,varargin)
    ...
    if numel(funargin) == cond1
        for i = 1 : cond1
            ...
            if ischar(funargin{i}) && i == cond1
                if strcmp(funargin{i},'nan')
                    varargout{i}  = 1; % Use NaN, remove zero values
                else
                    varargout{i}  = 0; % Dont Use NaN, do not remove zero values
                end
            else
                if cond1 == cond2
